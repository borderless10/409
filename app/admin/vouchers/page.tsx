...
import { getVouchers, createVoucher } from "@/lib/firestore"
...
function voucherStatus(v: Voucher): "active" | "scheduled" | "exhausted" | "expired" {
  const now = Date.now()
      ...
      {showForm && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Preencha os dados. Data de lançamento opcional: se informada, o cupom só ficará ativo a partir dessa data.</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <Button type="submit" disabled={submitting}>
                {submitting ? <Loader2 className="h-4 w-4 animate-spin" /> : "Criar cupom"}
              </Button>
            </form>
          </CardContent>
        </Card>
